...
public class ThumbnailDownloader<T> extends HandlerThread {
    ...
    private static final int MAX_SIZE_CACHE = 100 * 1024 * 1024;
    ...
    public ThumbnailDownloader(Handler responseHandler) {
        ...
        mIconCache = new IconCache(MAX_SIZE_CACHE);
    }
...
//            if (mIconCache.getBitmapFromMemory(url) == null) {
            ...
            /*} else {
                ...
                Log.i(TAG, "Bitmap extracted from cache");
            }
*/
    ...
    private class IconCache extends LruCache<String, Bitmap> {
